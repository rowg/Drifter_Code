...
anoMask = load('ANVOMask.txt');
m_plot(anoMask(:,1),anoMask(:,2),'b-');
...
% % save ANVO_OMA_Boundary OMA_boundary OMA_bi
...
% % generate_OMA_modes('ANVO_Test',OMA_boundary_smooth, ...
% %                    10,{},{},[],[],true);
...
% automatically.
generate_OMA_modes('ANVO_OMA_Domain.mat',OMA_boundary_smooth, ...
...
OMA_grid = grid(ind,:);
interp_OMA_modes_to_grid(OMA_grid,'ANVO_OMA_Domain.mat',[]);
