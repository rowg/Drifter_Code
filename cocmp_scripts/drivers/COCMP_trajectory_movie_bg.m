function [ ofn, hdls, p ] = COCMP_trajectory_movie_bg( D, p, varargin )
...
%% Web write?
try, p.TrajAnim.WebWrite;
catch
    p.TrajAnim.WebWrite = false;
end
...
[odn,ofn] = datenum_to_directory_filename( p.TrajAnim.PlotDir, D, ...
                                           ...
                                           p.TrajAnim.FileSuffix, p.MonthFlag );
odn = odn{1}; ofn = ofn{1};
...
if p.TrajAnim.WebWrite
    copyfile(ofn,fullfile(p.TrajAnim.WebBase,p.TrajAnim.WebName));
end
