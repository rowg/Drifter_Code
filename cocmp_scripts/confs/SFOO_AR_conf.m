...
conf.Radials.TimeChanges = [
             ...
             2006 07 20 00 00 00  %2 COMM,FORT,MONT, ideal to measured
             2007 09 15 00 00 00  %3 MONT meas to ideal
                                ];

conf.Radials.TimeChanges = datenum(conf.Radials.TimeChanges);

% Each of the Types corresponds to a TimeChanges element above.
conf.Radials.Sites        = {'BML1','BMLR','PREY','COMM','FORT','MONT','PESC','BIGC','PSLR'};
conf.Radials.TypesList{1} = {'RDLm','RDLm','RDLm','RDLi','RDLi','RDLi','RDLi','RDLi','RDLi'};
conf.Radials.TypesList{2} = {'RDLm','RDLm','RDLm','RDLm','RDLm','RDLm','RDLi','RDLi','RDLi'};
conf.Radials.TypesList{3} = {'RDLm','RDLm','RDLm','RDLm','RDLm','RDLi','RDLi','RDLi','RDLi'};
