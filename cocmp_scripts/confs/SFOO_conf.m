...
conf.Radials.Sites = {'BML1','BMLR','PREY','DRAK','COMM','SLID','FORT','MONT','PILR','PESC','BIGC','PSLR'};
conf.Radials.Types = {'RDLm','RDLm','RDLm','RDLi','RDLm','RDLi','RDLm','RDLm','RDLi','RDLi','RDLi','RDLi'};
...
% OMA boundary plot on totals plot
conf.Totals.OMAboundary = false;
%% OMA
