...
conf.Radials.Sites = {'DRAK','COMM','SLID','FORT','MONT','PILR','PESC','BIGC','PPIN','GCYN','PSLR'};
conf.Radials.Types = {'RDLi','RDLm','RDLi','RDLm','RDLm','RDLi','RDLi','RDLi','RDLi','RDLi','RDLi'};
