...
conf.Radials.Sites = {'PAFS','BMLR','BML1','PREY','DRAK','COMM','SLID','FORT','MONT','PILR','PESC','BIGC','SCRZ','MLML','NPGS','PPIN','GCYN','PSUR','PSLR','RAGG'};
conf.Radials.Types = {'RDLm','RDLm','RDLm','RDLm','RDLi','RDLi','RDLi','RDLi','RDLi','RDLi','RDLi','RDLi','RDLi','RDLi','RDLm','RDLi','RDLi','RDLi','RDLi','RDLm'};
...
conf.Totals.GridFile = fullfile(baseConfDir,'grids','CENT.grid');
